import { leerArchivoAutores, escribirArchivoAutores } from "../model/autoresModel.js";
...
const getTodosAutoresId = (req, res) => {
...
export {getTodosAutores, getTodosAutoresId, crearAutor, actualizarAutor, eliminarAutor}